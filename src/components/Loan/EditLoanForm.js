...
class EditLoanForm extends Component {
  ...
  handleSubmit(event) {
    ...
    if (amount === "") {
      this.setState(byPropKey("validationAmount", "Please enter loan amount"));
    } else {
      this.setState(byPropKey("validationAmount", null));
    }

    if (person === "") {
      this.setState(byPropKey("validationPerson", "Please enter person name"));
    } else {
      this.setState(byPropKey("validationPerson", null));
    }

    if (reason === "") {
      this.setState(byPropKey("validationReason", "Please enter loan reason"));
    } else {
    ...
    if (!isInvalid) {
      updateDoc(
        doc(
          firebase.db,
          `loanTable/${this.props.user.uid}/loans`,
          this.props.loan.key
        ),
        {
  ...
  render() {
    if (this.props.settings) {
      ...
      const { validationAmount, validationPerson, validationReason } =
        this.state;
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10 col-xs-6">
              ...
              />
              {validationAmount ? (
                <div className="invalid-feedback err">{validationAmount}</div>
              ) : (
                ""
              )}
            </div>
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10 col-xs-6">
              ...
              />
              {validationPerson ? (
                <div className="invalid-feedback err">{validationPerson}</div>
              ) : (
                ""
              )}
            </div>
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10 col-xs-6">
              ...
              />
              {validationReason ? (
                <div className="invalid-feedback err">{validationReason}</div>
              ) : (
                ""
              )}
            </div>
